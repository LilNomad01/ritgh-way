...
export function AdminPanel() {
  ...
  function newExerciseValues(lessonId: number) {
    ...
    return { lessonId, exerciseType: "listening_transcription", category: "Compreensão", title: "", prompt: "", optionsJson: "[]", correctAnswer: "", acceptedAnswersJson: "[]", explanation: "", speech: "", skillsJson: "[]", status: "Rascunho", position: count + 1 };
  }
